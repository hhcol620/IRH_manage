<template>
  <div>
    ...
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>需求举报</el-breadcrumb-item>
    </el-breadcrumb>
    <el-row class="container">
      <el-col :span="8"
        ...
        <div class="left">
          ...
          <div class="title">{{targetInfo.topic}}</div>
          <div class="desc_text">{{targetInfo.content}}</div>
          <div class="desc_img">
            <img :src="$store.state.ImgUrl + targetInfo.mainPic"
                 alt="">
          </div>
          <div class="desc_img"
               v-for="item in targetInfo.otherPics">
      ...
      <el-form :model="reportDetail"
        ...
        <el-form-item label="证明材料"
          ...
          <el-image style="width: 100px;"
                    v-for="it in reportDetail.picList"
