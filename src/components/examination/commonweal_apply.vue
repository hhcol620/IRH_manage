      ...
      <tree-table :data="donationApplyList"
        ...
        <template slot="operate"
          ...
          <el-button type="danger"
                     plain
                     size="mini"
                     v-if="scope.row.state === 2" @click="DonationDetailById(scope.row.id)">审核</el-button>
          <el-button type="primary"
                     plain
                     size="mini"
    ...
    <el-dialog title="审核"
      ...
      <el-form :model="donationDetail"
        ...
        <el-form-item label="申请人"
                      prop="applyUserId">
          <el-input v-model="donationDetail.applyUser.nickname" disabled></el-input>
        </el-form-item>
        <el-form-item label="申请金额"
                      prop="applyAmount">
          <el-input v-model="donationDetail.applyAmount" disabled></el-input>
        </el-form-item>
        <el-form-item label="申请理由"
                      prop="reason">
          <el-input v-model="donationDetail.reason" disabled></el-input>
        </el-form-item>
        <el-form-item label="支持次数"
                      prop="reason">
          <el-input v-model="donationDetail.userUpTotal" disabled></el-input>
        </el-form-item>
        <el-form-item label="不支持次数"
                      prop="reason">
          <el-input v-model="donationDetail.userDownTotal" disabled></el-input>
        </el-form-item>
        <el-form-item label="证明人姓名"
                      prop="witnessName">
          <el-input v-model="donationDetail.witnessName" disabled></el-input>
        </el-form-item>
        <el-form-item label="证明人电话"
                      prop="witnessPhone">
          <el-input v-model="donationDetail.witnessPhone" disabled></el-input>
        </el-form-item>
        <el-form-item label="提交时间"
                      prop="createTime">
          <el-input v-model="donationDetail.createTime" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item v-if="donationDetail.state === 2" label="审核反馈"
                      prop="remark">
          <el-input v-model="updateDonation.remark"></el-input>
        </el-form-item>

        <el-form-item v-if="donationDetail.state === 3" label="审核人"
                      prop="remark">
          <el-input v-model="updateDonation.approveId" disabled></el-input>
        </el-form-item>

        <el-form-item v-if="donationDetail.state === 3" label="审核反馈"
                      prop="remark">
          <el-input v-model="updateDonation.remark" disabled></el-input>
        </el-form-item>


        <el-form-item v-if="donationDetail.state === 2" label=""
                      prop="state">
      ...
      <span slot="footer"
        ...
        <el-button type="primary"
                   v-if="donationDetail.state === 2" @click="updateInfo">提交审核</el-button>
      </span>
    </el-dialog>
  </div>
</template>
    ...
    methods: {
      ...
      async updateInfo(){
        ...
        const { data: res } = await this.$http.post(
                `order/admin/donation/approve`, this.updateDonation
        )
        console.log(res)
